...
class GestureTest(object):
    ...
    def init_model(self):
        ...
        self.data_loader = DataLoader(
            Dataset(self.configer, self.normal_type, self.specific_path, self.width, self.height, self.data_path, self.crop_data_path, split="test", data_type=self.data_type,
